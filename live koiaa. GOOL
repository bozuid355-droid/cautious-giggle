...
<head>
    ...
    <style>
        body { background-color: #121212; color: #eee; font-family: 'Segoe UI', Tahoma, sans-serif; min-height: 100vh; }
...
<div class="modal fade" id="videoModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content bg-dark border-secondary">
            ...
            <div class="modal-body p-0 bg-black text-center" id="videoContainer">
                </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function loadMatchesUser() {
        // جلب البيانات بنفس الاسم المستخدم في كود الأدمن (live_matches)
    ...
    function openVideo(match) {
        ...
        document.getElementById('videoContainer').innerHTML = match.embed; // عرض كود التضمين
        videoModal.show();
    }
    ...
    // تحديث الصفحة تلقائياً كل 10 ثوانٍ للتحقق من مباريات جديدة
